...
%          keep_ind : changing those 2d indices into one that indexes (1x(90*180))
...
dodo = find(prof0.expand_xtrack == 45 | prof0.expand_xtrack == 46);
dodo = find(prof0.xtrack == 15 | prof0.xtrack == 16);
figure(1); clf;
