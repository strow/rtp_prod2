function airsL1c_backfill
% quick script to read AIRS L1C data into existing AIRIBRAD rtp
% files

fdir = '/asl/rtp/rtp_airibrad_v5/2016/allfov';
dname = {'018', '019', '020'};

l1cdir = 
% loop over doy
for doy = 1:length(dname)

    files = dir(fullfile(fdir, dname{i})
