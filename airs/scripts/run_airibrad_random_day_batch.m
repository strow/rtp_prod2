function run_airibrad_random_day_batch(cfg)
...
for i = 1:chunk
    ...
    [head, hattr, prof, pattr] = create_airibrad_random_day_rtp(infile, ...
                                                      cfg);
    % for jpss-1 testing
    C = strsplit(infile, '/');
    airs_yearstr = C{9};
    ...
    for i = 1:length(asType)
        ...
        fname = sprintf('%s_airibrad_day%s_%s.rtp', cfg.model, airs_doystr, asType{i});
        fprintf(1, '%s\n', fname);
