...
# sbatch options
#SBATCH --job-name=RUN_AIRICRAD_RAND
# partition = dev/batch
...
#SBATCH -o /home/sbuczko1/logs/sbatch/run_airicrad_rand_rtp-%A_%a.out
#SBATCH -e /home/sbuczko1/logs/sbatch/run_airicrad_rand_rtp-%A_%a.err
...
$MATLAB $MATOPT -r "addpath('~/git/swutils', '~/git/rtp_prod2_PROD/airs/scripts'); run_airicrad_rand; exit"
