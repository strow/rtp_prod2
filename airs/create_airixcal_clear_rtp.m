function [head, hattr, prof, pattr] = create_airixcal_clear_rtp(fnAirsInput, cfg)
%
% NAME
%   create_airixcal_clear_rtp -- wrapper to process AIRIXCAL to RTP
%
% SYNOPSIS
%   create_airixcal_clear_rtp(fnAirsInputopt)
%
% INPUTS
...
%      /asl/packages/swutil
func_name = 'create_airixcal_clear_rtp';
