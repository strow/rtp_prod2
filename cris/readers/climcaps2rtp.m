function [head, hattr, prof, pattr] = climcaps2rtp(nfile, opt)
...
prof.rtime = reshape(temp, 1, nobs);
clear temp;
...
iobs = 1:nobs;
prof.atrack = int32( 1 + floor((iobs-1)/30) );
prof.xtrack = int32( 1 + mod((iobs-1),30) );
...
hattr = {{'header', 'instid', 'CrIS/CLIMCAPS'}, ...
         {'header', 'reader', 'climcaps2rtp'}, ...
        };
