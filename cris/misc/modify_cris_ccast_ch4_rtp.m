function modify_cris_ccast_ch4_rtp(fnCrisInput)
% 
...
% modify CH4 profile contents (prof.gas_6) by multiplicative factor
% scale = [0.9, 1.1]
scale = 1.2;
prof.gas_6 = prof.gas_6 * scale;
...
fn_rtp2 = fullfile(sTempPath, ['cris_' sID '_2.rtp']);
rtpwrite(fn_rtp2, head, hattr, prof, pattr);
