function [iflags, bto1232, btc1232] = xfind_clear_loANDhires(head, prof, icheck, idtestIN);

% function [iflags, bto1232, btc1232] = xfind_clear(head, prof, icheck, idtest, ftest);
%
...
idtest0=[  276;   336;    425;   503;   635;    679;     698;   714;     762];
ftest0 =[819.375;856.875;912.5;961.25;1043.75;1071.25;1083.125;1093.125;1232.5];

idtest = idtestIN;
ftest  = ftest0(1:length(idtest));
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
