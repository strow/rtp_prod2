function create_cris_ccast_hires_rtp(fnCrisInput, cfg)
...
% $$$
rtp_out_fn_head = ['cris_hr_' cfg.model '_' dstr '_' tstr];
...
if iclear ~= 0
    rtp_out_fn = [rtp_out_fn_head, '_g' num2str(nguard) 's' ...
                  num2str(nsarta) '_' cfg.tag '_clear.rtp'];
