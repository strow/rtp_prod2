...
$MATLAB $MATOPT -r "disp('>>Starting script');set_process_dirs;disp('>>> set_process_dirs'); addpath(genpath(rtp_sw_dir));disp('>>>Addpath'); disp('>>>Running run_cris_batch');run_cris_batch; exit"
