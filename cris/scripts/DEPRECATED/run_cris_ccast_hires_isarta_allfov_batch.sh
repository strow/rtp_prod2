...
# sbatch options
#SBATCH --job-name=RUN_CREATE_CRIS_CCAST_ALLFOV_RTP
# partition = dev/batch
...
$MATLAB $MATOPT -r "disp('>>Starting script');addpath('/asl/packages/swutils');cfg=ini2struct('$1');run_cris_ccast_hires_isarta_allfov_batch(cfg); exit"
