...
.. table::
    ...
    +---------------------------------+----------------------------------------------------------------------------------+
    | klayers\\\ :sub:`code.junkdir`\ | path to scratch space for klayers input/output                                   |
    +---------------------------------+----------------------------------------------------------------------------------+
    | klayers\\\ :sub:`code.aeri`\    | path to klayers executable for AERI, (uplook, finer layers near ground)          |
    +---------------------------------+----------------------------------------------------------------------------------+
    | klayers\\\ :sub:`code.airs`\    | path to klayers executable for AIRS,IASI/CRiS (downlook, default klayers layers) |
    +---------------------------------+----------------------------------------------------------------------------------+
...
If iMatlab\\\ :sub:`vs`\\\\ :sub:`f77`\ == +1 then the Matlab files are
...
while if iMatlab\\\ :sub:`vs`\\\\ :sub:`f77`\ == -1 then the f77 files are
...
:math:`Test` has dokcarta\\\ :sub:`downlook.m`\, dokcarta\\\ :sub:`uplook.m`\ (very similar to the
"downlook" case) and dokcarta\\\ :sub:`opticaldepths.m`\.
